...
- [ ] Inventory the first verified Moon target
...
Run `tools/inventory_target.py` on the first local Moon target or extracted tree, register exact identity, then begin NCCH/ExeFS/RomFS structural mapping. Retail bytes and keys remain local.
